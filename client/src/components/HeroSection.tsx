      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 md:py-32">
        <div className="max-w-3xl">
          ...
          <p className="text-lg text-muted-foreground mb-8" data-testid="text-hero-subtitle">
            {t(
              'Надёжный контроль авто и автопарков: трекер GS900 + онлайн-сервис. Установка за 1 день. Тарифы от 2000 ₸/мес.',
              'Сенімді бақылау: GS900 трекері + онлайн сервис. Орнату — 1 күн. Тарифтер айына 2000 ₸-ден.'
            )}
          </p>
